...
;var mavJSON={
  ...
  , "fileIndexMap":
  {
    "h:/3 Year Project/OpenCL/Simple_Linear_Regression/device/simple_linear_regression.cl":"1"
  }
}
;var areaJSON={
          ...
          [
            {
              ...
              [
                ...
                , {
                  "info":
                  {
                    "name":"simple_linear_regression.cl:23"
                    , "data":
                    [62, 62, 0, 0]
                    , "debug":
                    [
                      [
                        {
                          "filename":"h:/3 Year Project/OpenCL/Simple_Linear_Regression/device/simple_linear_regression.cl"
                          , "line":23
                        }
                      ]
                    ]
                ...
                , {
                  "info":
                  {
                    "name":"simple_linear_regression.cl:24"
                    , "data":
                    [184.667, 398.333, 0, 0]
                    , "debug":
                    [
                ...
                , {
                  "info":
                  {
                    "name":"simple_linear_regression.cl:25"
                    , "data":
                ...
                , {
                  "info":
                  {
                    "name":"simple_linear_regression.cl:28"
                    , "data":
                    [905, 2021.5, 2.5, 0]
                    , "debug":
                    [
...
;var fileJSON=[{"index":0, "path":"h:/3 Year Project/OpenCL/Simple_Linear_Regression/device/simple_linear_regression.cl", "name":"simple_linear_regression.cl", "content":"//////////////////////////////////////////////////////////////////\012//Made by Samyuel Danyo on 06/11/2017\012/////////////////////////////////////////////////////////////////\012//This is OpenCL ACL kernel implementing a simple Linear Regression\012//neuron behavior. It is written for Intel FPGA, synthesized with\012//Intel SDK\012\012__kernel void simple_linear_regression(__constant float *restrict x,\012                       		__global float *restrict y)\012{\012	// Weights vector\012	__local float weights[4];\012	weights[0] = -0.55395846;\012	weights[1] = 1;\012	weights[2] = 10;\012    weights[3] = 8.94836441;\012	// Get index of the work item\012	int index = get_global_id(0);\012\012	// Creating the design vector\012	__local float features[4];\012	features[0] = 1;\012	features[1] = x[index];\012	features[2] = sin(3 * x[index]);\012    features[3] = exp(-1 * x[index] * x[index]);\012\012	// Executiong our inference\012	y[index] = features[0] * weights [0] + features[1] * weights [1] + features[2] * weights [2] + features[3] * weights [3];\012\012}\012\012"}];