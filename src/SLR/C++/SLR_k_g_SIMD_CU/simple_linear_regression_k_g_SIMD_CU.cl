...
{
	// Weights vector
	__local float weights[4];  //Maybe those will need to be in vector daa type float4
	...
	__local float features[4];    //Maybe those will need to be in vector data type float4
	features[0] = 1;
	features[1] = x[index];
