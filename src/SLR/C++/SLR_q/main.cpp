...
////Intel SDK
//SLR Run 1 kernel 2 queues, 1 thread
#include <iostream>
#include <cstdio>
#include <ctime>
#include <assert.h>
...
int main(int argc, char **argv) {
  ...
  printf("SLR Run: 1 Kernel, 2 Queues, 1 Thread");
  ...
  Simple_Linear_Regression slr1(n,i,s,e,f_name,log_f_name,kernel_name);
...
bool init_opencl() {
  ...
  std::string binary_file = getBoardBinaryFile("slr_q", device[0]);
...
void Simple_Linear_Regression::init() {
  ...
  for(unsigned i = 0; i < num_devices; ++i) {
    ...
    kernel_1[i] = clCreateKernel(program, kernel_name, &status);
